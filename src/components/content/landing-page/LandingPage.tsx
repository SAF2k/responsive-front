...
export default function LandingPage() {
  return (
    ...
    <>
      ...
      <section className="z-10 flex h-[85vh] md:h-[90vh] lg:h-[85vh] xl:h-[86vh] flex-col justify-evenly xl:justify-center lg:justify-center px-8 pb-8 mb-20 sm:mb-20 md:mb-20 lg:mb-20 sm:px-16 xl:px-36 xl:py-16">
